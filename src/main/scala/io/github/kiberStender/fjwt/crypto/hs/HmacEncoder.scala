...
object HmacEncoder:
  def hs1Encoder[F[*]: [F[*]] =>> MonadError[F, JWTError]]: HmacEncoder[F] =
    new HmacEncoder:
  ...
  def hs224Encoder[F[*]: [F[*]] =>> MonadError[F, JWTError]]: HmacEncoder[F] =
    new HmacEncoder:
      val alg: HmacEncoderAlgorithms = HmacEncoderAlgorithms.HS224
      def encode(privateKey: String)(str: String): F[String] = hmacEncoder(alg)(privateKey)(str)

  def hs256Encoder[F[*]: [F[*]] =>> MonadError[F, JWTError]]: HmacEncoder[F] =
    new HmacEncoder:
      val alg: HmacEncoderAlgorithms = HmacEncoderAlgorithms.HS256
      def encode(privateKey: String)(str: String): F[String] = hmacEncoder(alg)(privateKey)(str)

  def hs384Encoder[F[*]: [F[*]] =>> MonadError[F, JWTError]]: HmacEncoder[F] =
    new HmacEncoder:
      val alg: HmacEncoderAlgorithms = HmacEncoderAlgorithms.HS384
      def encode(privateKey: String)(str: String): F[String] = hmacEncoder(alg)(privateKey)(str)

  def hs512Encoder[F[*]: [F[*]] =>> MonadError[F, JWTError]]: HmacEncoder[F] =
    new HmacEncoder:
      val alg: HmacEncoderAlgorithms = HmacEncoderAlgorithms.HS512
      def encode(privateKey: String)(str: String): F[String] = hmacEncoder(alg)(privateKey)(str)

  def hMD5Encoder[F[*]: [F[*]] =>> MonadError[F, JWTError]]: HmacEncoder[F] =
    new HmacEncoder:
