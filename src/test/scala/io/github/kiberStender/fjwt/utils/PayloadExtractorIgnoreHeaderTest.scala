...
class PayloadExtractorIgnoreHeaderTest extends AnyFlatSpecLike:
  ...
  private lazy val payloadExtractor: PayloadExtractor[F, Payload] = PayloadExtractor.dsl(base64Decoder, hmacEncoder)

  "PayloadExtractorIgnoreHeader" should "extract the payload " in {
